...
class TenantLookupTest extends TestCase
{
    ...
    public function test_tenant_user_can_get_lookups(): void
    {
        ...
        $response->assertOk()
            ...
            ->assertJsonPath('data.expense_statuses.0.value', 'pending')
            ->assertJsonPath('data.supplier_statuses.0.value', 'active')
            ->assertJsonPath('data.purchase_order_statuses.0.value', 'draft')
            ->assertJsonPath('data.branch_statuses.0.value', 'active')
            ->assertJsonPath('data.vat_types.0.value', 'fixed')
            ->assertJsonPath('data.payment_statuses.0.value', 'pending')
            ->assertJsonPath('data.cashbox_statuses.0.value', 'active')
