        ...
        $this->routes = [
            'revenue_summary' => [
                'keywords' => [
                    ...
                    'دخلنا النهاردة',
                    // Monthly revenue
                    'إيرادات الشهر كام', 'إيرادات الشهر', 'إيراد الشهر كام', 'إيراد الشهر',
                    'ايرادات الشهر كام', 'ايرادات الشهر', 'ايراد الشهر كام', 'ايراد الشهر',
                    'دخل الشهر كام', 'دخل الشهر', 'دخول الشهر كام', 'دخول الشهر',
                    'مبيعات الشهر كام', 'مبيعات الشهر', 'مبيعات الشهريه',
                    'كام فلوس الشهر', 'فلوس الشهر كام', 'جمعنا كام الشهر',
                    'إجمالي الإيرادات', 'إجمالي ايرادات', 'اجمالي الايرادات',
                    'إيرادات يوليو', 'إيرادات يونيو', 'إيرادات اغسطس', 'إيرادات سبتمبر',
                    'ايرادات يوليو', 'ايرادات يونيو', 'ايرادات اغسطس', 'ايرادات سبتمبر',
                    'ربح الشهر', 'ارباح الشهر كام', 'ارباح', 'الربح',
                    ' turnover', ' collections', 'proceeds',
                ],
            ],
            'active_reservations' => [
                'keywords' => [
            ...
            'cashbox_balance' => [
                'keywords' => [
                    'رصيد الخزنة', 'رصيد الخزنه', 'خزنة كام', 'خزنه كام',
                    'كم رصيد الخزنة', 'كم رصيد الخزنه', 'الخزنة فيها كام',
                    'الخزنه فيها كام', 'كاش كام', 'المبلغ الكاش',
                    'رصيد الكاش', 'الكاش كام', 'صندوق كام', 'رصيد الصندوق',
                    'cashbox', 'cash balance', 'كام في الصندوق', 'فلوس الخزنة',
                    'المبلغ الموجود', 'الرصيد الحالي', 'رصيدنا كام',
                    'cash on hand', ' till balance', ' drawer balance',
                ],
            ],
            'daily_brief' => [
                'keywords' => [
